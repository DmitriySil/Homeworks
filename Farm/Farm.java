...
public class Farm {
    ...
    public void passDay(){
        int countDrAw0 = 0, countDrAw1 = 0, countDrAw2 = 0, driveAway,randomWild,randomPet,healthPet = 0,
...
//                            System.out.println(pets[randomPet].health);
                                    ...
                                    if (healthPet <= 0) {
                                        wilds[randomWild].seekAndDestroy(pets[randomPet]);
